...
#ifndef _WIN32
    // ------------ MAC OS requires x2 mul here for correct retina screen size
    glfw.width *= 2;
    glfw.height *= 2;
...
#ifndef _WIN32
    // --------------- MAC OS requires x2 division here for correct elements drawing
    projection.m[0] /= (glfw.width * 0.5f);
    projection.m[5] /= (glfw.height * 0.5f);
    // -----------------------------------------------------------------------------
#else
