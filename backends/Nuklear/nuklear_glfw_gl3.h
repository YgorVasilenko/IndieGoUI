...
// TODO - additional fonts loading function
NK_API 
void nk_glfw3_font_stash_end(struct nk_glfw* glfw) {
    ...
    // // Main font loading
    // nk_font* font = nk_font_atlas_add_from_file(&glfw->atlas, "fonts/Roboto-Regular.ttf", 20, &cfg);
    // if (font)
    //     std::cout << "Successfully loaded font!" << std::endl;
    // else
    //     std::cout << "Font loading failed!" << std::endl;
    // // std::string font_path = font_dir + "Data/Roboto-Regular.ttf";
    // // nk_font* font = nk_font_atlas_add_from_file(&glfw->atlas, font_path.c_str(), 20, &cfg);

    // // // gamepad buttons display
    // // font_path = font_dir + "Data/EsquireGenericGamepdFont_CL.ttf";
    // // nk_font * controls_display = nk_font_atlas_add_from_file(&glfw->atlas, font_path.c_str(), 50, &cfg);

    
    // // 
    // // EsquireGenericGamepdFont_CL
    // // loaded_fonts["main font"] = font;
    // // loaded_fonts["controls display"] = controls_display;
    ...
    // if (glfw->atlas.default_font) {
    //     std::cout << "Setting default font!" << std::endl;
    //     nk_style_set_font(&glfw->ctx, &glfw->atlas.default_font->handle);
    // }
}
